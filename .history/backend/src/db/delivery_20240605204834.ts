...
export const getDeliveryByUserIdAndAddressId = (user_id: number, address_id: number) => Delivery.findAll({ where: { user_id, address_id } });
export const getAvailableDelivery = () => Delivery.findAll({ where: { available: true } });
