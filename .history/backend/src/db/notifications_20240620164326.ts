...
export const createNotification = (notification: Record<string, any>) =>
  Notification.create(notification);
export const updateNotification = (id: string, values: Record<string, any>) =>
  Notification.findByIdAndUpdate(id, values);
export const deleteAllNotifications = () => Notification.deleteMany({});
