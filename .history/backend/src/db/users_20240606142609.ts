...
export const getUserByRefreshToken = (refreshToken: string) => User.findOne({ where: { refreshToken } });
...
export const getUserByUserType = (userType: string) => User.findAll({ where: { type: userType } });