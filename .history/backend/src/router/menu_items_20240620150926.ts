...
import {getARestaurantByItemId,getAllCategoriesWithMenuItemsByRestaurantId, deleteItemsByRestaurantId, deleteItem, updateItem, createItem, getItemsByCategoryId, getItemsByRestaurantId, getItemById,getItems} from '../controllers/menu_items';
import {isAuthenticatedOrDev} from '../middlewares';
export default (router: express.Router) => {
     ...
     */
   router.get('/menu_items',isAuthenticatedOrDev, getItems);
   /**
 * @swagger
 * /menu_items:
 *   get:
