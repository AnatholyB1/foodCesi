...
export const getAnOrderById = withLogging('',async(req: express.Request, res: express.Response) => {
    try {
        const {id} = req.params
...
export const createAnOrder = async(req: express.Request, res: express.Response) => {
    try {
...
export const updateAnOrder = async(req: express.Request, res: express.Response) => {
    try {
