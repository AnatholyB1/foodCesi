...
export const login = withLogging(async (req: express.Request, res: express.Response) => {
    try{
...
export const register = withLogging(async (req: express.Request, res : express.Response) => {
    try{
